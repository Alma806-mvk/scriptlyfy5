                    ...
                    <ol className="space-y-4">
                      {[
                        ...
                        >
                          ...
                          {i !== arr.length - 1 ? (
                            <span className="pointer-events-none absolute left-0 bottom-[-4px] -translate-x-[54%] rotate-45 w-1.5 h-1.5 border-r border-b border-slate-300"></span>
                          ) : null}
                        </li>
                      ))}
                    </ol>
                    ...
                    <ol className="space-y-4">
                      {[
                        ...
                        >
                          ...
                          {i !== arr.length - 1 ? (
                            <span className="pointer-events-none absolute left-0 bottom-[-4px] -translate-x-[54%] rotate-45 w-1.5 h-1.5 border-r border-b border-[hsl(var(--brand))]/60"></span>
                          ) : null}
                        </li>
                      ))}
                    </ol>
